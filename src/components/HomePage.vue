      ...
      >
        ...
        <at-select
          ...
          :style="
            backCard == 'No'
              ? 'width:100px;'
              : 'width:100px;background-color:rgb(39, 39, 39);'
          "
        >
          <at-option value="1">深圳</at-option>
          <at-option value="2">广州</at-option>
          <at-option value="3">广州</at-option>
          <at-option value="4">广州</at-option>
          <at-option value="5">广州</at-option>
          <at-option value="6">广州</at-option>
          <at-option value="7">广州</at-option>
        </at-select>
      </div>
    </div>
    <div
